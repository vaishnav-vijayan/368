    ...
    return (
        <Container>
            ...
            <div className="subdiv">
                ...
                <div className="text">
                    <p>
                        Article 51 . Posted in a Space you might.
                        Wed
                    </p>
                    <span> what is article 368? </span>
                </div>
                <div className="hover">
                    <svg
                        className="dots"
            ...
            <div className="subdiv">
                ...
                <div className="mid">
                    <p>Tue</p>
                    <span>Join Spaces on 368</span>
                    <p>
                        368 gets better when you follow Spaces. Find one that
            ...
            <div className="subdiv">
                ...
                <div className="text">
                    <p>
                        Indian penel code. Posted in a Space you might line .
                        Mon
                    </p>
                    <span>
                        {" "}
